---
title: "Data Structures And Data Wrangling"
...
```{r lapply_snowfall}
library(snowfall)
sfInit(cpus = 2, parallel = T) # initializes the structure of a cluster using multiple processors
