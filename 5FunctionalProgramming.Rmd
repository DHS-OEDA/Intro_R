...
Despite the extra overhead in starting and stopping the cluster, using `snowfall` saved us `r  (time1 - time3)["elapsed"] ` seconds of elapsed time!  Imagine how useful this can be when your looped runs for hours.
