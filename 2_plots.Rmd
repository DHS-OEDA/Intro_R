...
While I don't use these typically, it's worth knowing about how base R handles plots. 
...
### One useful base R plotting feature
...
This isn't the most straightforward (`ggplot2` does it better). 
...
Base R has a powerful plotting engine, but using it can be convoluted. It also doesn't produce publication quality graphs easily. It is probably best for some quick and dirty exploratory charts, and you may see it included in certain packages, but `ggplot2` does most everything better. 
